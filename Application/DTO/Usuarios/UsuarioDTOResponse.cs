...
public class UsuarioDTOResponse
{
    ...
    [Required(ErrorMessage = "{0} é obrigatório, ")]
    [CpfOrCnpjDocument(
        ErrorMessage = "{0} deve ser um CPF ou CNPJ realmente válido (apenas números), formato 'XXXXXXXXXXX' ou 'XXXXXXXXXXXXXX'."
    )]
    ...
    [Required]
    [BrazilPhoneNumber(
        ErrorMessage = "O {0} deve ser um número brasileiro válido (apenas numeros): XXXXXXXXXXX ou XXXXXXXXXX"
    )]
