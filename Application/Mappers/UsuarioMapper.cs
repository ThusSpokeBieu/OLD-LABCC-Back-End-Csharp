...
public class UsuarioMapper : Profile
{
    public UsuarioMapper()
    {
        CreateMap<UsuarioDTO, Usuario>()
            ...
            .ForMember(
                dest => dest.CpfOuCnpj,
                opt => opt.MapFrom(src => RegexConst.NotNumerical.Replace(src.CpfOuCnpj, ""))
            )
            .ForMember(
                dest => dest.Telefone,
                opt => opt.MapFrom(src => RegexConst.NotNumerical.Replace(src.Telefone, ""))
            )
            .ForMember(
                dest => dest.UserName,
                ...
                opt =>
                    opt.MapFrom(
                        src =>
                            (byte)
                                (GeneroEnum)
                                    StringEnumConverter.StringToEnum(src.Genero, typeof(GeneroEnum))
                    )
            )
        ...
        CreateMap<Usuario, UsuarioDTOResponse>()
            ...
            .ForMember(
                dest => dest.StatusDoUsuario,
                opt => opt.MapFrom(src => src.Status.Value ?? "Inativo")
            )
            .ForMember(dest => dest.Genero, opt => opt.MapFrom(src => src.Genero.Value ?? "Outro"))
            .ForMember(
                dest => dest.TipoDeUsuario,
