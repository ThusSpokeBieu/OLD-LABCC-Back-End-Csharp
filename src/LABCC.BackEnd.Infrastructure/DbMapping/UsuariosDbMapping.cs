  ...
  public void Seed(ModelBuilder modelBuilder)
  {
    var usuarios = new Usuario[]
    {
      new Usuario
      {
        ...
        DataDeNascimento = new  DateOnly(2000, 03, 26),
      ...
      new Usuario
      {
        ...
        DataDeNascimento = new DateOnly(2001, 05, 06),
        GeneroId = (byte) GeneroEnum.MASCULINO,
      ...
      new Usuario
      {
        ...
        DataDeNascimento = new DateOnly(1954, 05, 08),
      ...
      new Usuario
      {
        ...
        DataDeNascimento = new DateOnly(1996, 01, 03),
      ...
      new Usuario
      {
        ...
        DataDeNascimento = new DateOnly(1998, 05, 23),
        GeneroId = (byte) GeneroEnum.FEMININO,
