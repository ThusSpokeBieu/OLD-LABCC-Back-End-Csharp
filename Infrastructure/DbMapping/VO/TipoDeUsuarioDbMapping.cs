...
public class TipoDeUsuarioDbMapping
{
    ...
    {
        builder.Entity<TipoDeUsuario>().HasKey(t => t.Id);

        builder
            .Entity<TipoDeUsuario>()
            .Property(t => t.Sigla)
            .HasColumnOrder(1)
        ...
        builder.Entity<TipoDeUsuario>().HasIndex(t => t.Value).IsUnique();

        builder.Entity<TipoDeUsuario>().HasIndex(t => t.Sigla).IsUnique();
    ...
    public void Seed(ModelBuilder modelBuilder)
    {
        ...
        foreach (var tipoDeUsuario in tiposDeUsuarios)
            modelBuilder.Entity<TipoDeUsuario>().HasData(tipoDeUsuario);
    }
}
