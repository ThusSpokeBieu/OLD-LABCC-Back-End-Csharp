...
public class ColecoesDbMapping
{
  public void Build(ModelBuilder builder)
  {
    ...
    builder.Entity<Colecao>()
      .HasOne(c => c.Estacao)
      .WithMany()
      .HasForeignKey(c => c.EstacaoId);

    builder.Entity<Colecao>()
      .Property(c => c.EstacaoId)
      .HasColumnOrder(4)
      .HasComment("É o Identificador da estação da coleção: 1 - Primavera, 2 - Verão, 3 - Outono, 4 - Inverno")
      .IsRequired();
  ...
  public void Seed(ModelBuilder modelBuilder)
  {
    ...
    foreach (Colecao colecao in colecoes) modelBuilder.Entity<Colecao>().HasData(colecao);
  }
}